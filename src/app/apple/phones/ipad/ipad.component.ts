...
export class IpadComponent implements OnInit {
  ...
  {
    name:'Shikha Singh',
    review:" The IPAD contains Apple's A11 Bionic system-on-chip, which is a six-core processor with two cores optimized for performance and 4 cores for efficiency.",
    rating:5
  },
  {
    name:'Shivam Kumar',
    review:"I think it’s still one of the best your money can buy. Spending 49,990 for xs just for 30% faster processor ( who needs that, its already amazingly fast ) .",
    rating:3
  },{
    name:'Anjali Gupta',
